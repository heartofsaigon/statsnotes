...
beta0 = 0.5
beta1 = -1.2
times = seq(0,10, length= 10)|> round(2)|> unique()|> sort()
...
for(i in 1:10){
  ...
  r = paste0("main-result/s1/d1_",i,".rds")
  fit$save_object(r)
  print(i)
  beep()
}
...
#saveRDS(myresult, file = "main-result/simulation01.rds")

# read_rds("myresult-cox-time-varying01.rds")

# par(mfrow = c(1,2))
# lapply(`myresult-cox-time-varying01`, \(i) i[,"alpha_trt"])|>
#   reduce(cbind)|>
#   `colnames<-`(1:10)|>
#   boxplot(ylim = c(-4,2))
# abline(h = -0.5, col = 'red')
# lapply(`myresult-cox-time-varying02`, \(i) i[,"alpha_trt"])|>
#   reduce(cbind)|>
#   `colnames<-`(1:10)|>
#   boxplot(ylim = c(-4,2))
# abline(h = -0.5, col = 'red')
# 
# 
# lapply(`myresult-cox-time-varying01`, \(i) i[,"alpha_mark"])|>
#   reduce(cbind)|>
#   `colnames<-`(1:10)|>
#   boxplot()
# abline(h = 0.8, col = 'red')
# lapply(`myresult-cox-time-varying02`, \(i) i[,"alpha_mark"])|>
#   reduce(cbind)|>
#   `colnames<-`(1:10)|>
#   boxplot()
# abline(h = 0.8, col = 'red')
# 
# 
# lapply(`myresult-cox-time-varying01`, \(i) i[,"beta[2]"])|>
#   reduce(cbind)|>
#   `colnames<-`(1:10)|>
#   boxplot()
# abline(h = -1.2, col = 'red')
# lapply(`myresult-cox-time-varying02`, \(i) i[,"beta[2]"])|>
#   reduce(cbind)|>
#   `colnames<-`(1:10)|>
#   boxplot()
# abline(h = -1.2, col = 'red')
# 
# 
# lapply(`myresult-cox-time-varying01`, \(i) i[,"k"])|>
#   reduce(cbind)|>
#   `colnames<-`(1:10)|>
#   boxplot()
# abline(h = .5, col = 'red')
# lapply(`myresult-cox-time-varying02`, \(i) i[,"k"])|>
#   reduce(cbind)|>
#   `colnames<-`(1:10)|>
#   boxplot()
# abline(h = .5, col = 'red')
